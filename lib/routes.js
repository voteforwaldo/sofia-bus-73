...
export function buildJourneysForRoute(route, boardingDepartures, destinationStopIds, tripIndex) {
  return boardingDepartures.map((departure) =>
    buildJourney(departure, route, destinationStopIds, tripIndex),
  );
}
