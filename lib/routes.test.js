...
describe("getDirectionStopIds", () => {
  it("returns direction-specific stop ids when configured", () => {
    const stop = {
    ...
    expect(getDirectionStopIds(stop, "mladost")).toEqual(["6275"]);
    expect(getDirectionStopIds(stop, "ovchaKupel")).toEqual(["6564"]);
  });
});
